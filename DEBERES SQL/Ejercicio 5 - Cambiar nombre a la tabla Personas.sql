...
ALTER TABLE personas RENAME personas TO ciudadanos; /*Cambia el nombre de la tabla PERSONAS a CIUDADANOS.*/
...
DROP TABLE provincias CASCADE CONSTRAINTS; --Visualizar de nuevo las restricciones para las tablas PROVINCIAS y CIUDADANOS.
