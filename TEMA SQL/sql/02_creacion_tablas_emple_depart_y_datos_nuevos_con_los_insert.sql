...
ROLLBACK; --deshacer todos los pasos que he hecho  hasta ahora
desc depart --me sale el orden de las columnas que tiene la tabla
INSERT INTO DEPART (DEPT_NO,DNOMBRE)
VALUES (50,'INFORMATICA');-- es lo mismo que poner INSERT INTO DEPART (DNOMBRE,DEPT_NO) VALUES ('INFORMATICA',50);
select*from depart; --(esto lo usaría para ver si el insert value último que he hecho se ha ejecutado bien
UPDATE DEPART SET LOC = 'CORDOBA' WHERE DEPT_NO=50;
ROLLBACK;
UPDATE DEPART SET LOC = 'CORDOBA' WHERE DEPT_NO=50;
select*from depart;

UPDATE DEPART SET LOC='ARAIA',
                  DNOMBRE='EDUCACION'                  
WHERE DEPT_NO=50;

select*from depart;

UPDATE DEPART SET LOC=null,
                  DNOMBRE='EDUCACION'                  
WHERE DEPT_NO=50;
...
--TRANSACCION: conjunto de pasos que tienes que hacer en un orden concreto y que sean positivos.

COMMIT; -- la transaccion ha ido correcta y todos esos datos tienen que ser definitivos. No es necesario con 1)las sentencias DDL, 2)si estoy inactiva
--durante mucho tiempo, 3)si me desconecto o se desconecta el programa
